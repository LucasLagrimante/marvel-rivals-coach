    ...
    duelist: {
      ...
      dashGuide: {
        ...
        drills: [
          ...
          'Treino 4: treinar animation cancel — 4 golpes de LMB → pressionar melee ([key:V]) → repetir. Meça a diferença de DPS com e sem o cancel para internalizar o valor.',
  ...
  sources: [
    ...
    },
    {
      ...
      takeaways: [
        ...
        'Melee weave: 4 hits de LMB → melee [key:V] → repetir aumenta DPS total significativamente.',
      ],
    },
    {
